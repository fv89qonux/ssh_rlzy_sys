...
<head>
    ...
    <script src="<%=basePath %>indexdatayg.js" type="text/javascript"></script>
        <script type="text/javascript">
            ...
            function css_init()
            {
                ...
                { 
                    if (this.value)
                    {
                        location.href = "<%=basePath %>main.jsp?skin=" + this.value;
                    } else
                    {
...
<div id="topmenu" class="l-topmenu">
    <div class="l-topmenu-logo">人力资源管理系统</div>
