...
public class CloginAction extends ActionSupport {
	...
	@Resource EmloyeeloginDAO  employeeloginDAO; 
	...
	public String CheckLogin() { 
		...
		if (!employeeloginDAO.CheckLogin(employee)) {
			ctx.put("error",  java.net.URLEncoder.encode(employeeloginDAO.getErrMessage()));
			return "error";
		}
		ctx.getSession().put("username", employee.getEmployeeid());
		return "main_view";
